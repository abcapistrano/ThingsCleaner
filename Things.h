...
@class ThingsWindow, ThingsApplication, ThingsList, ThingsArea, ThingsPerson, ThingsTag, ThingsToDo, ThingsProject, ThingsSelectedToDo;
...
- (ThingsPerson *) addTeammateNamed:(NSString *)x;  // Add a teammate to Things from your Address Book
...
// Represents a Things teammate.
@interface ThingsPerson : ThingsList
...
@property (copy) ThingsPerson *delegate;  // To do delegate
